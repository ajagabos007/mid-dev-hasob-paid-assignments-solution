...
@section('page_title_buttons')
    ...
    <a data-toggle="tooltip" 
        title="New" 
        data-val='{{$broker->id}}' 
        class="btn btn-primary btn-new-mdl-broker-modal" href="#">
    ...
    <a data-toggle="tooltip" 
        title="Edit" 
        data-val='{{$broker->id}}' 
        class="btn btn-primary btn-edit-mdl-broker-modal" href="#">
...
@section('page_title_subtext')
    <a class="ml-10 mb-10" href="{{ route('sb.brokers.index') }}" style="font-size:11px;color:blue;">
        <i class="fa fa-angle-double-left"></i> Back to Broker List
    </a>
@stop
