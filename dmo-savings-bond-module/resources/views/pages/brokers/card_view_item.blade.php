...
<div class="card">
    ...
    <div class="row g-0">
        ...
        <div class="col-md-9">
            <div class="card-body">
                @php
                    $detail_page_url = route('sb.brokers.show', $data_item->id);
                @endphp

                <div class="d-flex align-items-center">
                    <div><h4 class="card-title"><a href='{{$detail_page_url}}'>{{$data_item->broker_code}}</a></h4></div>
                    <div class="ms-auto"> 
                        <a data-toggle="tooltip" 
                            title="Edit" 
                            data-val='{{$data_item->id}}' 
                            class="btn-edit-mdl-broker-modal inline-block mr-5" href="#">
                        ...
                        <a data-toggle="tooltip" 
                            title="Delete" 
                            data-val='{{$data_item->id}}' 
                            class="btn-delete-mdl-broker-modal inline-block mr-5" href="#">
                            <i class="bx bxs-trash-alt txt-danger" style="opacity:80%"></i>
                        </a>
                    </div>
                </div>

                <p class="card-text">{{$data_item->full_name}}</p>
                <p class="card-text">
