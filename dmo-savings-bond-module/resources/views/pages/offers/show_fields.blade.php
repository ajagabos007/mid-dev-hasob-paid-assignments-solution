<div class="row">
    ...
    <div id="div_offer_offer_title" class="col-sm-12 mb-10">
        <p>
            {!! Form::label('offer_title', 'Offer Title:', ['class'=>'control-label fw-bold']) !!} 
    ...
    <hr/>
     <!-- Offer Organization id Field -->
        <div id="div_offer_organization_id" class="col-sm-12 mb-10">
            <p>
                {!! Form::label('organization_id', 'Organization:', ['class'=>'control-label fw-bold']) !!} 
                <span id="spn_offer_organization_id">
                @if (isset($offer->organization) && empty($offer->organization)==false)
                   <a href="{{route('fc.organizations.show', $offer->organization->id)}}">{!! $offer->organization->org !!} </a> 
                @else
                    N/A
                @endif
                </span>
    ...
    <div id="div_offer_max_units_per_investor" class="col-sm-12 mb-10">
        <p>
            {!! Form::label('max_units_per_investor', 'Max Units Per Investor:', ['class'=>'control-label fw-bold']) !!} 
