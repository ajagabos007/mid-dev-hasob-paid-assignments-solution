...
class CreateSubscriptionAPIRequest extends AppBaseFormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'wf_status' => 'nullable|string|max:100',
            'wf_meta_data' => 'nullable|string|max:1000',
            'units_requested' => 'nullable|min:0|max:365',
            'price_per_unit' => 'nullable|min:0|max:100000000',
            'total_price' => 'nullable|min:0|max:100000000',
            'interest_rate_pct' => 'nullable|min:0|max:100',
            'offer_start_date' => 'nullable|date_format:Y-m-d H:i:s',
            'offer_end_date' => 'nullable|date_format:Y-m-d H:i:s',
            'offer_settlement_date' => 'nullable|date_format:Y-m-d H:i:s',
            'offer_maturity_date' => 'nullable|date_format:Y-m-d H:i:s',
            'tenor_years' =>'nullable|integer',
            'investor_email' => 'required|email',
            'investor_telephone' => 'nullable|string|max:20',
            'first_name' => 'required|string',
            'middle_name' => 'required|string',
            'last_name' => 'required|string',
            'date_of_birth'=>'nullable|date_format:Y-m-d H:i:s',
            'origin_geo_zone' => 'required|string|max:100',
            'origin_lga' => 'required|string|max:100',
            'address_street' => 'required|string|max:200',
            'address_town' => 'required|string|max:200',
            'address_state' => 'required|string|max:200',
            'bank_account_name' => 'required|min:2|max:100',
            'bank_account_number' => 'required|string|max:10',
            'bank_name' => 'nullable|string|max:100',
            'bank_verification_number' => 'required|string|max:100',
            'national_id_number' => 'required|string|max:100',
            'cscs_id_number' => 'required|string|max:100',
            'chn_id_number' => 'required|string|max:100'
        ];
    }
