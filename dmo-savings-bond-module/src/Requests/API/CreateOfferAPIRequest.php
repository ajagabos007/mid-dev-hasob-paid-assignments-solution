...
class CreateOfferAPIRequest extends AppBaseFormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'offer_start_date' => 'required|date_format:Y-m-d H:i:s',
            'offer_end_date' => 'required|date_format:Y-m-d H:i:s',
            'offer_settlement_date' => 'required|date_format:Y-m-d H:i:s',
            'offer_maturity_date' => 'required|date_format:Y-m-d H:i:s',
