...
class BrokerController extends BaseController
{
     ...
     * @return Response
     */
    public function store(Broker $broker, CreateBrokerRequest $request)
    {
        $input = $request->all();
     ...
     * @return Response
     */
    public function update(Broker $broker, UpdateBrokerRequest $request)
    {
        /** @var Broker $broker */
        $broker = Broker::find($broker->id);
    ...
    public function processBulkUpload(Broker $broker, Request $request){
